...
#!/bin/bash
cd /var/www/html
echo '<html><head><title>Picture of my dog</title></head> <body><h1>Look at my dog</h1><img src="http://${yandex_storage_bucket.my_bucket.bucket_domain_name}/bp.jpg"/></body></html>' > index.html
EOF
    }
  }
